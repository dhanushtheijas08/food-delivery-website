...
function PriceCard({ isPrimary }) {
  const primaryCard = isPrimary ? "bg-[#fae5d3] border-0" : null;
  return (
    <div
      className={`w-fit text-center border-2 border-[#fae5d3] rounded-2xl px-9 py-14 md:px-9 lg:px-20 lg:py-20 mt-20 space-y-6 lg:space-y-8 ${primaryCard}`}
    >
      {/* Card Heading */}
      <label className="text-orangeDark font-medium text-xl">STARTER</label>
