...
function MealsCard({ foodName, foodImgPath }) {
  return (
    <div className="shadow-lg hover:shadow-2xl transition duration-500 cursor-pointer rounded-xl bg-[hsl(0 0% 90%)]">
      ...
      <div className="space-y-3 px-5 pt-5 pb-6">
        <div className="mx-auto w-fit flex text-center gap-2">
          <HighLightText classname="text-white bg-[#ff5722]">
            Vitamin Rich
          </HighLightText>
          <HighLightText classname="text-white bg-[#4caf50]">
            Natural Booster
          </HighLightText>
        </div>

        <SubHeading classname="text-center lg:text-[1.8rem]">
          {foodName}
        </SubHeading>
